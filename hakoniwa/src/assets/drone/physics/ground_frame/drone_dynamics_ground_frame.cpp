...
{
    (void)thrust;
    this->next_angularVelocity.data.x = ((1.0/this->param_cx) * torque.data.x * this->delta_time_sec) + this->angularVelocity.data.x;
...
{
    (void)thrust;
    this->next_angularVelocity.data.y = ((1.0/this->param_cy) * torque.data.y * this->delta_time_sec) + this->angularVelocity.data.y;
...
{
    (void)thrust;
    this->next_angularVelocity.data.z = ((1.0/this->param_cz) * torque.data.z * this->delta_time_sec) + this->angularVelocity.data.z;
