...
#define HAKO_AVATOR_CHANNEL_ID_CMD_MAG      12
#define HAKO_AVATOR_CHANNEL_ID_STAT_MAG     13
#define HAKO_AVATOR_CHANNEL_ID_LIDAR_DATA   14
#define HAKO_AVATOR_CHANNEL_ID_LIDAR_POS    15
#define HAKO_AVATOR_CHANNLE_ID_CTRL         16 /* for pid control program only */
/*
