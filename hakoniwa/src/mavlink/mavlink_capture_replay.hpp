...
extern bool mavlink_capture_load_data(MavlinkCaptureControllerType &controller, uint32_t dataLength, uint8_t  *data, uint32_t *r_dataLength, uint32_t *r_owner, uint64_t *timestamp);
