...
extern bool drone_pdu_data_deep_copy(const HakoniwaDronePduDataType& source, HakoniwaDronePduDataType& dest);
class IDroneService {
public:
    ...
    virtual void peek_pdu(HakoniwaDronePduDataType& pdu) = 0;
};
